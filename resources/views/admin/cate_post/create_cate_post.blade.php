...
@section('noidungchinh')
    ...
    <div class="title_post d-flex my-3">
        <h2 class="me-3">Thêm danh mục bài viết</h2>
    </div>
    <form enctype="multipart/form-data" class="m-auto" id="frm" method="post" action="/admin/storeCatePost"> @csrf
        <div class="row">
            <div class="col-xl-8">
                <div class="d-flex">
                    <div class='mb-3 px-2' style="width: 100%">
                        <label><b>Tên danh mục bài viết</b></label> <span style="color: red">*</span>
