...
@section('noidungchinh')
    <div class="title_post d-flex my-3">
        <h2 class="me-3">Thêm Banner</h2>
    </div>
    <form class="m-auto" id="frm" method="post" action="/admin/storebanner" enctype="multipart/form-data"> @csrf
        <div class="row">
            <div class="col-xl-8">
                        ...
                        @foreach ($positions as $key => $position)
                            <div class="form-check ms-2">
                                <input class="form-check-input" type="radio" 
                                    id="flexCheckDefault"
                                    value="{{ $key}}" name="position" required>
