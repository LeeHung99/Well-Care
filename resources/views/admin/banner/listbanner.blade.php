                ...
                <tbody>
                    @foreach ($banner as $index => $item)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="/admin/editbanner{{$item->id_image_banner}}">Sửa</a>
                                <form class="d-inline" action="/admin/destroybanner{{$item->id_image_banner}}" method="POST">
                                    @csrf
