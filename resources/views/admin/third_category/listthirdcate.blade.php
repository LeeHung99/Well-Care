                        ...
                        <tbody>
                            @foreach ($thirdcategories as $index => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->order}}</td>
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="/admin/editthirdcategory{{$item->id_third_category}}">Sửa</a>
                                        <form class="d-inline" action="/admin/destroythirdcategory{{$item->id_third_category}}" method="POST">
                                            @csrf
